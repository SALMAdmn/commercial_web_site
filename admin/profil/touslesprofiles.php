...
$r=mysqli_query($con,$sql) or die('erreur exec recet');
	if(mysqli_num_rows($r)==0){
		echo "<h3 style='color:red; text-align:center;'>ne sont pas valable</h3>";
	}
		else
		{
...
while($d = mysqli_fetch_array($r)){
  ...
  echo $d['mdp'];
  echo "</td >";
  echo "<td><a href='modifierprofil.php?id=".$d['email']."'>modifier</a></td>";
   echo '<td><a href="#" onclick="showModal(\'supprimerprofil.php?id='.$d['email'].'\')">supprimer</a></td>';
	echo "</tr>";
}
...
<a href="ajouterprofil.php" class="ajouter"><i class="fas fa-plus"></i>&nbsp ajouter</a>
</div>
