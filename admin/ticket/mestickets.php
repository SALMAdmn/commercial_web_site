...
$sql="select * from ticket where demandeur='".$_SESSION['email']."'";
...
$r=mysqli_query($con,$sql) or die('erreur exec recet');
    if(mysqli_num_rows($r)==0){
        ...
        { $sql1="select count(*) as count1 from ticket where demandeur='".$_SESSION['email']."'";
          $r1=mysqli_query($con,$sql1);
          $d1 = mysqli_fetch_assoc($r1);
          $count1=$d1['count1'];

          $sql2="select count(*) as count2 from ticket where demandeur='".$_SESSION['email']."' and statut='encours'";
          $r2=mysqli_query($con,$sql2);
          $d2 = mysqli_fetch_assoc($r2);
          $count2=$d2['count2'];

          $sql3="select count(*) as count3 from ticket where demandeur='".$_SESSION['email']."' and statut='terminé'";
...
echo '<a href="image/'.$d['id'].'.png" class="ouvrir">ouvrir image</a>';
    ...
    echo "</td>";
  echo "<td><a href='modifierticket.php?id=".$d['id']."'>modifier</a></td>";
   echo '<td><a href="#" onclick="showModal(\'supprimerticket.php?id='.$d['id'].'\')">supprimer</a></td>';
    echo "</tr>";
}
