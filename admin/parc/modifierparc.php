...
if(isset($_POST['utilisateur']) and isset($_POST['lieu']) and isset($_POST['entreprise']) and isset($_POST['poste']) and isset($_POST['modéle']) and isset($_POST['marque']) and isset($_POST['livreur']) and isset($_POST['description'])){

  if(!empty($_POST['utilisateur']) and !empty($_POST['lieu']) and !empty($_POST['entreprise']) and !empty($_POST['poste']) and !empty($_POST['modéle']) and !empty($_POST['marque']) and !empty($_POST['livreur']) and !empty($_POST['description'])) {

$con=mysqli_connect('localhost','root','','autohall') or die('Impossible d\'accerder auserveur');
$sql="UPDATE parc
  SET utilisateur ='".$_POST['utilisateur']."', lieu ='".$_POST['lieu']."', entreprise ='".$_POST['entreprise']."', poste ='".$_POST['poste']."', modéle ='".$_POST['modéle']."', marque ='".$_POST['marque']."', livreur ='".$_POST['livreur']."', description ='".$_POST['description']."', modification ='".$modification."' 
  where nom ='".$_GET['id']."' ";


   if(mysqli_query($con,$sql)){ 
    if (isset($_FILES['document']) and $_FILES['document']['error']!==UPLOAD_ERR_NO_FILE) {
...
$chemindest = $dossier.'/'.$_GET['id'].'.pdf';
...
$sql="select * from parc where nom='".$_GET['id']."'";
$r=mysqli_query($con,$sql) or die('erreur exec recet');
$d=mysqli_fetch_array($r);
?>
<section class="table">
<div class="tableau">
  <h1>Modifier <?php echo $d['nom']; ?></h1>
  <br>
...
echo "<tr>";
  ...
  echo "</th >";
  echo "<td>";
  echo "<input type='text' name='utilisateur' value='".$d['utilisateur']."'>";
  echo "</td >";
  echo "</tr>";
...
echo "<tr>";
    echo "<th>";
  echo "Entreprise de vente";
  echo "</th >";
  echo "<td>";
  echo "<input type='text' name='entreprise' value='".$d['entreprise']."'>";
  echo "</td >";
  echo "</tr>";
  ...
  echo "</th >";
  echo "<td>";
  echo "<input type='text' name='poste' value='".$d['poste']."'>";
  echo "</td >";
  echo "</tr>";

echo "<tr>";
    echo "<th>";
  echo "Modéle identifié";
  echo "</th >";
  echo "<td>";
  echo "<input type='text' name='modéle' value='".$d['modéle']."'>";
  echo "</td >";
  echo "</tr>";
  ...
  echo "</th >";
  echo "<td>";
  echo "<input type='text' name='marque' value='".$d['marque']."'>";
  echo "</td >";
  echo "</tr>";
  ...
  echo "</th >";
  echo "<td>";
  echo "<input type='text' name='livreur' value='".$d['livreur']."'>";
  echo "</td >";
  echo "</tr>";
  ...
  echo "<tr>";
    echo "<th>";
  echo "Document connexe";
  echo "</th >";
  echo "<td>";
  echo "<input type='file' id='document' name='document' accept='.pdf'></div>
";
  echo "</td >";
  echo "</tr>";
